...
const ChatBox = () => {
	...
	const [editingMessage, setEditingMessage] = useState(null) // Przechowuje wiadomość do edycji
	const [selectedMessage, setSelectedMessage] = useState(null) // Przechowuje wiadomość z otwartym menu
	...
	const sendMessage = async () => {
		try {
			if (editingMessage) {
				...
				setEditingMessage(null) // Zakończ edycję
